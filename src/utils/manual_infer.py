...
import pandas as pd
import time
from transformers import T5Config, T5ForConditionalGeneration, RobertaTokenizer, AutoTokenizer, AutoModelForCausalLM, AutoModelForSeq2SeqLM
...
def code_t5_rl(data_path,file_path, output_path):
    ...
    model = AutoModelForSeq2SeqLMWithValueHead.from_pretrained(file_path)

    model = model.to('cuda')

    ls_data = []
    for example in data_gen(data_path):
    ...
    # df.to_csv(output_path+str(time.time())+".csv", index=False)


def code_t5(data_path,file_path, output_path):
    # tokenizer = RobertaTokenizer.from_pretrained("Salesforce/codet5-small")
    # # model = T5ForConditionalGeneration.from_pretrained("/home/ip1102/projects/def-tusharma/ip1102/Ref_RL/POC/extract-method-generation/src/refactoring-finetune/CodeT5/sh/saved_models/refactoring/codet5_small_all_lr5_bs32_src320_trg256_pat5_e100/checkpoint-best-bleu")
    # model = T5ForConditionalGeneration.from_pretrained(file_path)
...
if __name__=="__main__":
    ...
    #         model_path,
    #         "/home/ip1102/projects/def-tusharma/ip1102/Ref_RL/POC/extract-method-generation/src/reinforcement-learning/results/")
    code_t5_rl("/home/ip1102/projects/def-tusharma/ip1102/Ref_RL/POC/extract-method-generation/src/reinforcement-learning/test-data/val.jsonl",
            model_path,
            "/home/ip1102/projects/def-tusharma/ip1102/Ref_RL/POC/extract-method-generation/src/reinforcement-learning/results/")    
